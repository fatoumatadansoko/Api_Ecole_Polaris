...
Route::middleware('api')->prefix('ues')->group(function () {
...
Route::middleware('api')->prefix('matieres')->group(function () {
...
Route::middleware('api')->prefix('evaluations')->group(function () {
